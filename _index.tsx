  ...
  return (
    <>
      ...
      <nav className="bg-blue-900">
        <div className="max-w-5xl mx-auto px-4 flex h-16 lg:h-20 w-full">

          {/* Logotipo */}
          <div className="flex items-center">
            <img className="h-10 md:h-12 lg:h-14" src="imagens/logo.png" alt="Logo" />
          </div>
      ...
      <section className="relative">
        ...
        <div className="absolute inset-0 mx-auto flex max-w-3xl flex-col items-center justify-center text-center text-white">
          ...
          <h1 className="mb-4 text-lg font-bold leading-tight md:text-4xl lg:text-6xl">
            Sistema Especializado em <br /> Industria, Comércio, Saúde e Distribuição
          </h1>

          <p className="mb-4 text-xs md:text-xl lg:text-2xl">
            Gestão para tornar o seu negócio mais lucrativo
          </p>
          <a href="#contato" className="text-xs rounded-md bg-white p-2 text-gray-600 hover:text-gray-400" > Entre em Contato </a>
        </div>
      </section>
      ...
      <section className="bg-gray-200 flex items-center justify-center p-5">
        <div className="bg-gray-800 max-w-7xl w-full rounded-lg">
          ...
          <div className="flex justify-center items-center p-2">
            <div className="grid grid-cols-3 mt-5 mb-16">
              ...
              <div className="flex flex-col justify-center">
                ...
                <div className="text-gray-400">
                  ...
                  <p>De segunda a sexta <br /> das 8:00 ás 11:30 e 14:00 ás 17:30</p>
                </div>
              </div>
            </div>
          </div>
