export function NavBar() {
  return (
    <nav className="bg-blue-900">
      <div className="max-w-5xl mx-auto px-4 flex h-16 w-full justify-between sm:h-20">
        {/* Logotipo */}
        ...
        <div className="hidden md:flex justify-center items-center">
          <div className="flex justify-center items-center space-x-4 mx-2">
            <a href="#segmentos" className="text-white hover:text-gray-300">
              Segmentos
            </a>
            <a
            ...
            <a href="#sobre" className="text-white hover:text-gray-300">
              Sobre Nós
            </a>
        ...
        <div className="flex justify-center items-center">
          <a
            href="#contato"
            className="text-gray-600 bg-white rounded-md p-1 hover:text-gray-400 hidden md:block"
          >
            Entre em Contato
          </a>
        </div>
