        ...
        <section className="bg-gray-200 flex items-center justify-center p-5">
            <div className="bg-gray-800 max-w-7xl w-full rounded-lg text-justify text-xs">
                ...
                <div className="flex justify-center items-center p-4">
                    <div className="grid grid-row-3 gap-4 mb-10">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="text-gray-400">
                                ...
                                <p>
                                    De segunda a sexta das 8:00 ás 11:30 e 14:00 ás 17:30
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="m-3 border-t-2 border-gray-400 p-4">
                    <div className="flex flex-col items-center justify-center text-gray-400 gap-4">
                        <p>
                            Mendes Informática Ltda. | 96.841.671/0001-54
                        </p>
                        <p className="hover:text-gray-300">
                            Todos os direitos reservados
                        </p>
                        <p className="mt-5">
                            Desenvolvido por <a href="#" className="hover:text-white">Felipe Mendes</a>
                        </p>
                    </div>
                </div>
            </div>
