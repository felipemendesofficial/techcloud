            ...
            <form className="p-4" action="#" method="POST">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="name"
                  name="name"
                  className="w-full px-3 py-2 border rounded-md text-xs text-gray-600 border-gray-300 focus:outline-none focus:border-blue-600"
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white font-semibold py-2 rounded-md hover:bg-blue-800 transition duration-300"
              >
                Enviar
              </button>
            </form>
